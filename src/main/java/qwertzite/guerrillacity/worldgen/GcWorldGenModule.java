...
public class GcWorldGenModule extends GcModuleBase {
	...
	public static final String KEY_CITY_BIOME = "city";
	public static final String KEY_SNOWY_CITY_BIOME = "snowy_city";
	...
	public GcWorldGenModule() {
		...
		CITY_BIOME = this.biome(new BiomeRegister(KEY_CITY_BIOME, plains(false)));
		SNOWY_CITY_BIOME = this.biome(new BiomeRegister(KEY_SNOWY_CITY_BIOME, plains(true)));
		
	}

	public Biome plains(boolean snowy) {
...
//		BiomeDefaultFeatures.addDefaultSprings(biomeGeneration);
		...
		if (snowy) { this.snowySpawns(mobspawnSettings); }
		else { this.plainsSpawns(mobspawnSettings); }
...
//		else { BiomeDefaultFeatures.addPlainVegetation(biomeGeneration); }
	...
	private void plainsSpawns(MobSpawnSettings.Builder p_126793_) {
...
//		p_126793_.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.DONKEY, 1, 1, 3));
	...
	private void snowySpawns(MobSpawnSettings.Builder builder) {
